Hooks:PostHook(WeaponFactoryTweakData, "create_bonuses", "Type99IncModInit", function(self)
	...
	self.parts.wpn_fps_fla_system_b_standard.animations = {equip = "equip", unequip = "unequip", fire = "recoil", fire_steelsight = "recoil", reload = "reload", reload_not_empty = "reload"}
	...
	self.parts.wpn_fps_fla_system_b_wtf.animations = {equip = "equip", unequip = "unequip", fire = "recoil", fire_steelsight = "recoil", reload = "reload", reload_not_empty = "reload"}
